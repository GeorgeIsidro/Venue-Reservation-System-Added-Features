...
<body>
  <div class="main">
    ...
    <div class="button-container">
		<button class = "view" id="view" onclick= "window.location.replace('view_reservations.php');" class="reserve-button">View All Equipment Reservations<button>
        <button class = "reservation" id="reservation" onclick="window.location.replace('reservation_form.php');" class="reserve-button">Reserve</button>
        <button class = "home" id="home" onclick="window.location.replace('home-2.php');">Home</button>
    </div>
  </div>
  </div>
</body>
