...
<div class="main">
 ...
 <div class="container">
  ...
  <br>
  <button onclick="window.open('view-database.php')">View Venue Reservations</button>
  
  <br>
  <button onclick="window.open('reservation_form.php')">Reserve Equipment Here</button>
