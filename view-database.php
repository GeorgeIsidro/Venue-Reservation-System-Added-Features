...
<button onclick="printReservationsForMonth()">Print Reservations for the Month</button>

<button onclick="printReservationsPerVenue()">Print Reservations per Venue</button>
