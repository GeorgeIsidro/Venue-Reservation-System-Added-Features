...
try {
    ...
    echo '<h2 style="color: #ffffff;">Search Reservations by Date</h2>';
    ...
    echo '<h2 style="color: #ffffff;">Search Venue Availability</h2>';
    echo '<form action="" method="post">';
...
<form action="print-reservations-month.php" method="post">
  <input type="submit" value="Print Reservations for the Month">
</form>
	
<form action="print-reservations-venue.php" method="post">
