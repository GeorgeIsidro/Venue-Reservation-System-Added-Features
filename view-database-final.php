...
<body>
  ...
  <div class = "main">
    ...
    <h2 class = "header-3-tag">Search Venue Availability</h2>
    <form class = "header-3" action="" method="post">
    <input type="text" name="search_venue" placeholder="Enter venue name" required>
    <input type="submit" name="search_by_venue" value="Search">
    </form>
        ...
        */
        if (isset($reservations)) {
            ...
            foreach ($reservations as $reservation) {
                ...
                echo '<td><button style="border-radius: 5px;" onclick="sendConfirmationEmail(\'' . $reservation['email'] . '\')">Send Confirmation</button></td>';
  ...
  <a href = "reservations.php"> <button class="btn btn-primary">Make A Reservation</button> </a>
  ...
  <a href = "navbar-practice.html"><button class="btn btn-warning">Home</button></a>
